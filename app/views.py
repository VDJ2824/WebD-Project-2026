        ...
        for i in range(len(names)):
            if names[i].strip():
                ...
                if result["status"] == "error":
                    messages.error(
                        request,
                        f"{names[i]} ({ids[i]}): Scopus sync failed"
                    ...
                    messages.warning(
                        request,
                        f"{names[i]} ({ids[i]}): faculty saved, but no new papers were added."
                    )
                else:
                    messages.success(
                        request,
                        f"{names[i]} ({ids[i]}): added successfully with {result['stored_count']} papers."
                    )
